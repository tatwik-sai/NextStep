...
const Postings = () => {
    ...
    const InterviewDetailsModal = ({ isOpen, onClose, interview }) => {
        ...
        return (
            <div className="fixed inset-0 bg-black/80 bg-opacity-50 z-50 flex justify-center items-center p-4" onClick={onClose}>
                <div
                    className="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto transform transition-all p-6"
                    onClick={(e) => e.stopPropagation()}
                >
                    <div className="flex justify-between items-start border-b border-black/30 pb-4 mb-4">
    ...
    const InterviewsDashboard = () => {
        ...
        const TabButton = ({ id, name }) => (
            <button
                ...
                className={`px-4 py-2 text-base font-semibold transition-all duration-200 rounded-t-lg ${activeTab === id
        ...
        <div className="min-h-screen bg-gray-50 font-sans">
            <header className="bg-white shadow-md sticky top-0 z-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    ...
                    <p className="text-md text-gray-500 mt-1">Review and manage candidate interviews for scheduling and feedback.</p>
                </div>
            </header>
